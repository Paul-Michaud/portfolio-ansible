...
echo -e "
 ${BOLD}Projects${NC}
    ...
    ${BOLD}Writeup Breizh CTF 2k16${NC}
    (${BOLD}${ORANGE}python${NC}, ${BOLD}${ORANGE}php${NC}, ${BOLD}${ORANGE}java${NC}, ${BOLD}${ORANGE}wookie${NC})
    (https://github.com/Paul-Michaud/BreizhCTF-2k16)
"